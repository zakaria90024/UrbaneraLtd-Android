package com.largeit.urbaneraltd.HomeFragment.TopOneRecycler;
...
public class TopOneAdapter extends RecyclerView.Adapter<TopOneViewHolder> {
    ...
    public TopOneAdapter(HomeFragment homeFragment, List<TopOneModel> posts, Context mContext) {
    ...
    @NonNull
    @Override
    public TopOneViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_topone, parent, false);

        TopOneViewHolder viewHolder = new TopOneViewHolder(itemView);
    ...
    @Override
    public void onBindViewHolder(@NonNull TopOneViewHolder holder, int position) {
