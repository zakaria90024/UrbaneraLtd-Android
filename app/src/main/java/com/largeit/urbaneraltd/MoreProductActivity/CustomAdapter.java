...
import com.largeit.urbaneraltd.MoreProductActivity.ViewHolder;
...
public class CustomAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    Context mContext;
    MoreProductActivity productActivity;
    //HomeActivity homeActivity;
    public List<Product> posts;

    public CustomAdapter(MoreProductActivity productActivity, List<Product> posts) {
